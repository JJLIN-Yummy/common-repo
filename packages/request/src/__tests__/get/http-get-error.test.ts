...
describe('GET请求错误测试', () => {
  ...
  // });
  createHttpErrorTest(() => request().response(), '测试GET 401错误请求', 401);
  createHttpErrorTest(() => request().response(), '测试GET 403错误请求', 403);
  createHttpErrorTest(() => request().response(), '测试GET 404错误请求', 404);
  createHttpErrorTest(() => request().response(), '测试GET 500错误请求', 500);
});
